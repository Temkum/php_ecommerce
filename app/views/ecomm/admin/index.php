            ...
            <section class="wrapper">
                ...
                <div class="row">
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-md-4 col-sm-4 mb">
                                <div class="white-panel pn">
                                    ...
                                    <div class="centered">
                                        <img src="<?= ASSETS ?>admin/img/product.png" width="120">
                                    </div>
                                </div>
                            </div><!-- /col-md-4 -->
                    ...
                    <div class="col-lg-3 ds">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/img/ui-divya.jpg" width="35px" height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/img/ui-sherman.jpg" width="35px" height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/img/ui-danro.jpg" width="35px" height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/img/ui-zac.jpg" width="35px" height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS ?>admin/img/ui-sam.jpg" width="35px" height="35px" align="">
                            </div>
                            <div class="details">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var unique_id = $.gritter.add({
                ...
                title: 'Welcome to <?= WEBSITE_TITLE ?>!',
